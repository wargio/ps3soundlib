...
int main(int argc, const char* argv[])
{
    ...
    DrawFormatString(0, text_y, "Initializing SPUs... %08x", sysSpuInitialize(6, 5));
    text_y += 32;

    DrawFormatString(0, text_y, "Initializing raw SPU... %08x", sysSpuRawCreate(&spu, NULL));
    text_y += 32;
    ...
    DrawFormatString(0, text_y, "    Entry Point: %08x    Segment Count: %08x", entry, segmentcount);
    text_y += 32;
